<template>
    <div class="flex" :style="display ? 'display:none' : ''">
        ...
        <AppButton
            v-tippy="'Cadastrar Industria'"
            type="button"
            class="h-9"
            @click="
                model = null;
                openSliderIndustry = true;
            "
        >
        ...
        <AppButton
            v-if="model"
            v-tippy="'Atualizar Industria'"
            type="button"
            class="h-9 ms-1 bg-primary-light"
            @click="openSliderIndustry = true"
        >
            <PencilSquareIcon class="w-4 h-4"></PencilSquareIcon>
        </AppButton>
    </div>
    <AppSlideOversIndustry
        :industry="model"
        :openSliderIndustry="openSliderIndustry"
        @closeClick="
            openSliderIndustry = false;
            model = null;
            loading();
        "
    />
...
import AppSlideOversIndustry from "../SlideOvers/AppSlideOversIndustry.vue";

const openSliderIndustry = ref(false);
...
watch(
    () => [props.reload, openSliderIndustry.value],
